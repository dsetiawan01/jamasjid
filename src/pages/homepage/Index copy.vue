<template>
  ...
  >
    ...
    font-style: italic;"
      ...
      >
        <!-- <div class="row q-col-gutter-x-xs" style="height: 200px"> -->
        <!-- <div class="col-6"> -->
        <!-- <div class="row  q-col-gutter-sm full-height"> -->
        <!-- <div
                class="col-sm-3 bg-teal"
                style="background: #00bcd4a6"
                v-for="index in 4"
                :key="index"
              ></div> -->
        <!-- </div> -->
        <!-- </div> -->
        <!-- <div class="col-6">
            <div class="row q-col-gutter-sm  full-height q-col-gutter-x-sm">
              <div
                class="col-3 bg-teal"
                style="background: #00bcd4a6"
                v-for="index in 4"
        ...
        <div class="">
          <div class="row q-col-gutter-md q-pa-md " style="height: 220px">
            ...
            <!-- <div class="col-3 " v-for="n in 5" :key="`none-${n}`">
              <div class="my-content bg-white">&nbsp;</div>
            </div> -->
          </div>
        </div>

        <div
          style="height: 30px; width: 100%; background: black"
          class="flex justify-center items-center"
        >
          <div class="text-white">&copy;Copyright Pemuda Sukawening 2021</div>
